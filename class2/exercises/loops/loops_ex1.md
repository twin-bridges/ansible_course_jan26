...
a. Create a task1 with a name of 'Simple loop' use 'ansible.builtin.debug' and a loop structure to print out the name of four firewalls (for example, 'fw1, fw2, fw3, fw4').
b. Create a variable in the vars section with a name of 'my_firewalls'. This 'my_firewalls' variable should be a list of four firewall names. Create a task2 that loops over 'my_firewalls' and prints out the names of the four firewalls ('debug' module).
c. In the vars section create the following dictionary named 'firewall_dict':
...
d. In the vars section of the playbook create a variable named 'fw_list' which is a list of dictionaries and looks as follows:
